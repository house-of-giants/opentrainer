...
- **Useful, not trendy** — Every AI interaction must provide tangible value
- **Science-backed** — Recommendations grounded in exercise physiology and biomechanics
- **Token-efficient** — Pre-aggregate data server-side, never send raw entries to AI
- **Trust-building** — Always explain the "why" behind recommendations
...
GUIDELINES:
1. This is an EARLY snapshot — do NOT make confident claims about trends or progression.
...
6. Do NOT include scores — not enough data for reliable scoring.
...
│                                        │
│ 6 workouts logged.                     │
│ Your Training Lab report is ready.     │
│                                        │
...
│ 🧪 Training Lab                    PRO │
│                                        │
│ Your training snapshot is ready.       │
│                                        │
│ Log 1 more workout for full insights.  │
│ [4/5 workouts]  ████████████░░░        │
│                                        │
│ [Generate Snapshot]                    │
└────────────────────────────────────────┘
...
│ 🧪 Training Lab                    PRO │
│                                        │
│ Log 2 more workouts to unlock your     │
│ training snapshot.                     │
│                                        │
│ [1/3 workouts]  ████░░░░░░░░           │
└────────────────────────────────────────┘
...
```
┌────────────────────────────────────────┐
│ ← Training Lab         Dec 21-27, 2025 │
├────────────────────────────────────────┤
│                                        │
│ "Your volume is up 15% this week with  │
│  stable RPE. Great progressive         │
│  overload execution."                  │
│                                        │
├────────────────────────────────────────┤
│ SCORES                                 │
│ ┌────────┐ ┌────────┐ ┌────────┐ ┌────┐│
│ │Vol: 85 │ │Int: 78 │ │Bal: 72 │ │Rec │││
│ │   ██   │ │   ██   │ │   █░   │ │ 90 │││
│ └────────┘ └────────┘ └────────┘ └────┘│
├────────────────────────────────────────┤
│ VOLUME BY MUSCLE                       │
...
│ INSIGHTS                               │
│                                        │
│ 🔴 HIGH: Rear delt volume is 40%       │
│    below your pressing volume.         │
│    → Add 2 sets of face pulls to       │
│      push days.                        │
│                                        │
│ 🟡 MEDIUM: Squat RPE trending up       │
│    while weight is flat.               │
│    → Consider a deload next week.      │
│                                        │
│ 🟢 LOW: Great bench press progress.    │
│    Top weight up 10lbs this month.     │
│                                        │
└────────────────────────────────────────┘
```
...
```
┌────────────────────────────────────────┐
│ ← Training Snapshot    Dec 21-24, 2025 │
├────────────────────────────────────────┤
│                                        │
│ "Good start! You've logged 4 workouts  │
│  with solid chest and back focus."     │
│                                        │
├────────────────────────────────────────┤
│ YOUR VOLUME                            │
│                                        │
...
│ Legs       ████              4 sets    │
│                                        │
│ Total: 38 sets · ~9.5 sets/workout     │
├────────────────────────────────────────┤
│ OBSERVATIONS                           │
│                                        │
│ ✓ Strong upper body focus this week    │
│                                        │
│ 💡 Consider adding a leg day to        │
│    balance your training               │
│                                        │
├────────────────────────────────────────┤
│ ┌────────────────────────────────────┐ │
│ │ 📊 Log 1 more workout to unlock    │ │
│ │    your full Training Lab report   │ │
│ │    with scores and trend analysis  │ │
│ └────────────────────────────────────┘ │
└────────────────────────────────────────┘
```
...
│ ┌────────────────────────────────────┐ │
│ │ ⭐ Chest-Supported Row              │ │
│ │ Similar horizontal pull with less  │ │
│ │ lower back stress. Uses dumbbells. │ │
│ │                          [Select]  │ │
│ └────────────────────────────────────┘ │
│                                        │
│ ┌────────────────────────────────────┐ │
│ │ Seated Cable Row                    │ │
│ │ Equivalent lat/rhomboid stimulus.  │ │
...
│ ┌────────────────────────────────────┐ │
│ │ Inverted Row                        │ │
│ │ Bodyweight option, same movement   │ │
│ │ pattern. Easier to load.           │ │
│ │                          [Select]  │ │
│ └────────────────────────────────────┘ │
│                                        │
│ ⚠️ This is your 2nd swap for rows     │
│ due to discomfort this month.         │
│                                        │
│ [Cancel]                               │
└────────────────────────────────────────┘
```
...
│                                        │
│ ┌────────────────────────────────────┐ │
│ │ You swapped Barbell Row due to     │ │
│ │ discomfort.                        │ │
│ │                                    │ │
│ │ Would you like to permanently      │ │
│ │ replace it in "Pull Day A"?        │ │
│ │                                    │ │
│ │ [Keep Original]  [Replace →]       │ │
│ └────────────────────────────────────┘ │
│                                        │
│ [Done]                                 │
└────────────────────────────────────────┘
